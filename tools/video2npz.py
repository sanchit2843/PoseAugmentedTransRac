...
class MyDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if not os.path.exists(npy_pth):
            ...
            try:
                ...
                print('error:', index, filename,
                      'is wrong npz which cant opened.')
    ...
    def read_video(self, video_filename, filename, width=224, height=224):
        ...
        np.savez(npy_pth, imgs=frames,
                 fps=original_frames_length)  # [f,c,h,w]
        return 1
...
if __name__ == '__main__':
    data_root = r'/mnt/workspace/UMD/CMSC733/CMSC733_project/LLSP/video'
    tag = ['train', 'valid', 'test']
    npy_dir = r'/mnt/workspace/UMD/CMSC733/CMSC733_project/repcount_npz_128/'
